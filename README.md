# brewery-finder
JavaScript app using Google services to find breweries in a specified area (but search settings can be modified to search for almost anything)
...
app = {
  init: function() {
    this.settings = {
      search: {
        itemType: 'brewery', // Can change: This can be set to anything that you'd like to search for
        ...
        primaryTypes: ['bar'], // Array w/ empty string or multi-string (examples: [''], ['type1'], ['type1, 'type2'], etc.)
        
        // secondaryTypes: Any result having these types will be listed after primaryTypes
        secondaryTypes: ['restaurant', 'food'], // Array w/ empty string or multi-string (examples: [''], ['type1'], ['type1, 'type2'], etc.)
        
        // excludedTypes: Any result having these types will excluded from the results
        excludedTypes: ['store'], // Array w/ empty string or multi-string (examples: [''], ['type1'], ['type1, 'type2'], etc.)
